...
<html>
	...
	<body>
		...
		<div class="container-xl">
			...
			<h5 class="text-center mb-5">년도별 평균 지출</h5>
			...
			<script>
				let chartData = {
				    ...
				    data: {
				        ...
				        datasets: [{
				            label: '년도별 평균 지출',
				            backgroundColor: 'rgba(255, 192, 128, 0.5)',
				            borderColor: 'rgba(255, 192, 128, 0.5)',
				            data: []
				        }]
				    },
				    options: {}
				...
				$.ajax({
					url: '${pageContext.request.contextPath}/admin/rest/chart2',
					type: 'get',
