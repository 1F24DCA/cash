...
<html>
	...
	<body>
		...
		<div class="container-xl">
			...
			<h5 class="text-center mb-5">년도별 가장 많이 쓴 지출</h5>
			...
			<script>
				let chartData = {
				    ...
				    data: {
				        labels: [],
				        datasets: [{
				            label: '년도별 가장 많이 쓴 지출',
				            backgroundColor: 'rgba(192, 128, 255, 0.5)',
				            borderColor: 'rgba(192, 128, 255, 0.5)',
				            data: []
				        }]
				    },
				    options: {}
				...
				$.ajax({
					url: '${pageContext.request.contextPath}/admin/rest/chart8',
					type: 'get',
