...
<html>
	...
	<body>
		...
		<div class="container-xl">
			...
			<h5 class="text-center mb-5">년도별 가장 적게 쓴 지출</h5>
			...
			<script>
				let chartData = {
				    data: {
				        labels: [],
				        datasets: [{
				            label: '년도별 가장 적게 쓴 지출',
				            backgroundColor: 'rgba(255, 128, 192, 0.5)',
				            borderColor: 'rgba(255, 128, 192, 0.5)',
				            data: []
				        }]
				    },
				    options: {
				...
				$.ajax({
					url: '${pageContext.request.contextPath}/admin/rest/chart9',
					type: 'get',
					success: function(data) {
						...
						window.myPolarArea = Chart.PolarArea(context, chartData);
					}
				});
			</script>
		</div>
