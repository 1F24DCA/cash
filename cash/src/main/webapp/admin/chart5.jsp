...
<html>
	...
	<body>
		...
		<div class="container-xl">
			...
			<h5 class="text-center mb-5">년도별 총 수익</h5>
			...
			<script>
				let chartData = {
				    ...
				    data: {
				        ...
				        datasets: [{
				            label: '년도별 총 수익',
				            steppedLine: true,
				            backgroundColor: 'rgba(128, 255, 192, 0.5)',
				            borderColor: 'rgba(128, 255, 192, 0.5)',
				            data: []
				        }]
				    },
				    options: {}
				...
				$.ajax({
					url: '${pageContext.request.contextPath}/admin/rest/chart5',
					type: 'get',
