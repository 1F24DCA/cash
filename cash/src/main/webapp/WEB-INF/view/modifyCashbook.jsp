...
<body>
	...
	<div class="container-xl">
		<h2 class="text-center mb-5">MODIFY CASHBOOK</h2>
		...
		<form method="post" action="${pageContext.request.contextPath}/admin/modifyCashbook">
			<table class="table table-sm table-borderless px-5 text-center">
				<tr class="border-top border-bottom">
					...
					<td class="w-75">
						<input type="text" name="cashbookId" 
				...
				<tr class="border-bottom">
					...
					<td>
						<input type="text" name="cashbookPrice" value="${cashbook.cashbookPrice}" class="form-control">
					</td>
				</tr>
				<tr class="border-bottom">
					<td class="font-weight-bold">CONTENT</td>
					<td>
						<input type="text" name="cashbookContent" value="${cashbook.cashbookContent}" class="form-control">
					</td>
				</tr>
				<tr>
					<td colspan="2">
						<button type="submit" class="btn btn-success btn-block">MODIFY CASHBOOK</button>
					</td>
				</tr>
			</table>
		</form>
